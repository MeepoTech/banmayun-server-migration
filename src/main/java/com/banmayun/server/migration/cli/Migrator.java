...
public class Migrator {
    ...
    private void migrateOneUser(User user) throws Exception {
        ...
        try {
            ...
            com.banmayun.server.migration.to.core.User createdUser = this.userDAO.createUser(newUser);
    ...
    private void migrateOneGroup(Group group) throws Exception {
        ...
        try {
            ...
            System.out.println("G: " + group.getId() + " -> " + createdGroup.getId() + "  rootId = "
                    + createdRoot.getId());
    ...
    private void migrateSpaces() throws Exception {
        ...
        while (true) {
            ...
            for (User user : users) {
                System.out.println("Migrate User Space:  id = " + user.getId() + ", newRootId = "
        ...
        while (true) {
            ...
            System.out.println("Migrate Groups: " + groups.size());
            for (Group group : groups) {
                System.out.println("Migrate Group Space:  id = " + group.getId() + ", newRootId = "
    ...
    private void migrateOneSapceRevisions(Long groupId, Long newRootId) throws Exception {
        ...
        while (true) {
            ...
            for (Revision revision : revisions) {
                ...
                newRevision.setModifiedBy(this.userIds.get(revision.getModifiedBy()));
